...
function integrateWasmJS() {
    var wasmTextFile = "pcsx_worker.min.wast";
    var wasmBinaryFile = "pcsx_worker.min.wasm";
    var asmjsCodeFile = "pcsx_worker.min.temp.asm.js";
...
STATICTOP = STATIC_BASE + 1116288;
__ATINIT__.push({
    func: (function() {
        ___emscripten_environ_constructor()
    })
});
var STATIC_BUMP = 1116288;
